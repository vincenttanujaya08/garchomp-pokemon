...
/**
 * Main Application Entry Point
 * CAVE TEST VERSION - Focus on Cave Only
 */
...
function main() {
  ...
  // Transform cave: position, rotation, scale
  // Position: di tengah scene, sedikit di bawah
  mat4.translate(cave.localTransform, cave.localTransform, [0, -8, -35]);

  // Scale: besar untuk jadi focal point
  mat4.scale(cave.localTransform, cave.localTransform, [2.5, 2.5, 2.5]);

  // Rotate sedikit untuk angle yang lebih menarik (optional)
  // mat4.rotateY(cave.localTransform, cave.localTransform, Math.PI * 0.1);
...
console.log("🗻 Cave Test Mode Loaded");
